    ...
    return (<div className="w-full  h-[100vh] flex flex-col">
        <div className={"h-[95vh] flex items-center"}>
            ...
            <div className="w-[45%]  flex flex-col gap-8 pl-14 ">
                ...
                <h3 className="text-4xl font-bold tracking-wide">Join Twitter today</h3>
                ...
                <p className=" w-[80%] text-sm">By signing up you agree to <span className="text-blue-400">Terms of Service</span> and <span
                    className={"text-blue-400"}>Privacy Policy</span>,including <span className={"text-blue-400"}>Cookie Use</span>.
                </p>
                <div className="flex gap-2">
                    <p>Already have account ? </p>
                    <Link to={"/login"}>
                    <p className="text-[#1DA1F2] hover:cursor-pointer hover:underline">Log in</p>
                    </Link>
                </div>
            </div>
        </div>
        <div className={"h-[5vh] flex justify-center items-center"}>
            <div className="flex text-[10px]  gap-2.5 ">
                ...
                <p className={"hover:underline hover:cursor-pointer"}>Brand Resources</p>
                ...
                <p className={"hover:underline hover:cursor-pointer"}>Twitter for Business </p>
